...
${cleanedTranscript}`
    ...
    // Troisième appel OpenAI : Extraire les tâches avec assignation améliorée et regroupement
...
- Sois précis dans la description de chaque tâche REGROUPÉE
- N'invente pas de tâches qui ne sont pas mentionnées
- ÉVITE les doublons en regroupant intelligemment

**EXEMPLES DE BON REGROUPEMENT:**
- Au lieu de : "Contacter Infomaniak", "Configurer SMTP", "Tester email" 
- Faire : "Configuration complète email Infomaniak : contact commercial + setup SMTP + tests"
- Au lieu de : "Réserver salle", "Commander matériel", "Inviter participants"
- Faire : "Organisation formation complète : réservation salle + matériel + invitations participants"
...
IMPORTANT: Retourne UNIQUEMENT un JSON valide avec cette structure exacte :
{
  "tasks": [
    {
      "description": "Description précise de la tâche REGROUPÉE avec toutes les sous-actions",
