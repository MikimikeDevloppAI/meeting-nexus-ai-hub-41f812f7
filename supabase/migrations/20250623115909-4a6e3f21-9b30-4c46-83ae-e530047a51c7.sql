...
-- Nettoyage complet et définitif de TOUTES les politiques RLS
-- Cette migration supprime absolument toutes les politiques existantes sur toutes les tables
-- puis crée une seule politique universelle par table pour éliminer les conflits

-- 1. SUPPRESSION EXHAUSTIVE de toutes les politiques existantes
...
-- 2. CRÉATION des nouvelles politiques universelles (UNE SEULE PAR TABLE)
